...
<main class="checkout-page">
      <div class="container">
        ...
        <div class="checkout-page-layout">
          <form class="checkout-form" id="checkout-page-form">
              ...
              <div class="option-list">
                <label class="option-card">
                  ...
                  <div class="option-card-body">
                    ...
                    <span class="option-meta">Dự kiến 1-2 ngày • 25.000₫</span>
                  </div>
                </label>
                <label class="option-card">
            ...
            <footer>
              <a href="cart.jsp" class="btn"> Thay đổi sản phẩm </a>
              <a href="./order_complete.html" class="btn">
                Xác nhận đặt hàng
              </a>
            </footer>
          </form>
          ...
          <aside class="checkout-order-summary">
            ...
            <div class="summary-main empty" style="display: none">
              <p>
